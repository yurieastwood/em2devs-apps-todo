...
Feature: Progressive Disclosure and Onboarding
  ...
  Background:
    Given I am a new user creating an account
  ...
  # ───────────────────────────────────────────
  # Retroactive Activation (Phase 2)
  # ───────────────────────────────────────────

  Rule: When the gamification layer activates, users see progress they already earned

    Scenario: Retroactive XP reveal
      Given I have been using Waypoint for 3 weeks in Phase 1 (pre-gamification)
      And I have completed 45 tasks during that time
